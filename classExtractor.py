        ...
        for line in f:
            try:
                ...
                if counter % 100000 == 0:
                    ...
                    writeClasslist(classesList, 'classesP279_1611.txt')
                    writeClasslist(classesP31, 'classesP31_1611.txt')
                    writeClasslist(superClasses, 'superclasses_1611.txt')
                    classesList = []
                    classesP31 = []
                    superClasses = []
...
def main():
    ...
    # minClasses = classJoiner(superclasses)

    #write files
    writeClasslist(classP279, 'classesP279_1611.txt')
    writeClasslist(classP31, 'classesP31_1611.txt')
    writeClasslist(superclasses, 'superclasses_1611.txt')
